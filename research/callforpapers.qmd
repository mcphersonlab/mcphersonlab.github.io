...
def create_callforpapers_html(papers_data):
    ...
    # Convert "TBD" and "Ongoing" to far future dates for sorting purposes
    for paper in papers_data:
        if paper['due_date'] == 'TBD':
            paper['sort_date'] = datetime(9999, 12, 30)
            paper['display_date'] = 'TBD'
        elif paper['due_date'] == 'Ongoing':
